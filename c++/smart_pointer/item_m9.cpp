...
// 不用对所有的指针说再见，
// 但是你需要对用来操纵局部资源（local resources）的指针说再见。
...
// processAdoptions没有捕获异常，
// 所以异常将传递给processAdoptions的调用者。
// 传递中，processAdoptions函数中，
// 调用pa->processAdoption语句后的所有语句都被跳过，
// 这就是说pa没有被删除。
// 结果，任何时候pa->processAdoption抛出一个异常，
// 都会导致processAdoptions内存泄漏。
// 堵塞泄漏很容易：
...
// 资源应该被封装在一个对象里，遵循这个规则，
// 你通常就能避免在存在异常环境里发生资源泄漏。
