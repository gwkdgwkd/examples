...
int main() {
  ...
  // 由于C++98标准使用期间，NULL已经得到了广泛的应用，出于兼容性的考虑，
  // C++11标准并没有对NULL的宏定义做任何修改。
  ...
  // 由于nullptr无法隐式转换为整形，而可以隐式匹配指针类型，因此执行结果和预期相符。

  // 总之在C++11标准下，相比NULL和0，使用nullptr初始化空指针可以令程序更加健壮。
