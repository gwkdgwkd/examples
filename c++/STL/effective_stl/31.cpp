...
// partial_sort和nth_element效果基本相同，
// 不同的是partial_sort排序了，nth_element没有排序。

// 对于等价的元素，partial_sort和nth_element有自己的做法，
// 无法控制它们的行为。
...
int main() {
  ...
  // 调用partition后，所有满足要求的都被放在了begin和goodEnd之间的区间中。
  // 其他大在goodEnd到end之间的区间中。
