...
void func() {
  ...
  // 'n2::test3::HeapTracked::MissingAddress'
...
// 也没有可移植的方法判断地址是否不在堆中，所以很不走运，不过这也丝毫不奇怪，
// 毕竟如果能辨别出某个地址在堆上，也就能辨别出某个地址不在堆上。
