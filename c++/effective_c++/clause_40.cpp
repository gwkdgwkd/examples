...
// 多重继承是继承一个以上的base class，一般base class没有有更高级的base class，
// 否则会导致要命的“钻石型多重继承”：
class File {};
class InputFile : public File {};
class OutputFile : public File {};
class IOFile : public InputFile, public OutputFile {};
// 任何时候如果你有一个继承体系而其中某个base class和某个derived class之间有一条以上的相同路线，
// 就必须面对这样一个问题：
...
// 1.使用virtual继承的class错产生的对象往往比使用non-virtual继承的对象体积大；
// 2.访问virtual base class的成员变量时，也比访问non-virtual base class的成员变量速度慢。
// virtual继承的成本还包括其他方面，
// 支持virtual base class初始化”规则比起non-virual base的情况远为复杂且不直观。
...
// 多重继承的确有正当用途。
// 其中一个情节涉及“public继承某个Interface class”和“private继承某个协助实现的class”的两相组合。
