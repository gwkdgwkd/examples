...
void func() {
  ...
  // 要是加强版本的程序，
  // 只需把调用child_fun::child_fun_implement_v1::child_fun_v1()，
  // 全部替换成child_fun::child_fun_implement_v2::child_fun_v1()
  child_fun1::child_fun_v1();  // 默认版本
  // child_fun_v1
  child_fun1::child_fun_implement_v2::child_fun_v1();  // 加强版本
  // child_fun_v2
}
}  // namespace n2
