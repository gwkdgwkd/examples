...
// C++自带4种字面量：整形123、浮点型12.3、字符'1'、字符串"123"
// 字面量又可添加后缀来表明具体类型：
// 无符号整形(unsigned int):123u、长整形(long):123l
...
// 那么必然难逃先初始化变量，然后传值或传引用调用函数，这就导致了编程过程中出现的不直观。
// struct T {};
// void func(T t1, T t2) {}
// T temp1(xxxx);
// T temp2(xxxx);
// func(temp1, temp2);
// 为什么对于void func(int, double)可以直接使用func(12, 3.14)调用，而不用
// int a = 12;
// double b = 3.14;
// func(a, b);
// 这便是字面量的威力，可以直接更加直观的字符串信息进行隐式的类型转换和函数调用，
// 从而使得逻辑更为直观。
