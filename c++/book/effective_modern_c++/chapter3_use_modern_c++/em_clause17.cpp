...
// Rule of Three规则说如果声明了拷贝构造函数，拷贝赋值运算符，
...
// Rule of Three的解释依然有效，再加上对声明拷贝操作阻止移动操作隐式生成的观察，
...
namespace test1 {
// 实际上，就算编译器乐于生成拷贝和移动操作，生成的函数也如你所愿，
// 也应该手动声明它们然后加上=default，这看起来比较多余，但是它让你的意图更明确，
// 也能帮助你避免一些微妙的bug，比如，有一个类来表示字符串表，
