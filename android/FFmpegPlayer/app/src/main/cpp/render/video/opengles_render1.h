#ifndef RENDER_VIDEO_OPENGL_RENDER1_H
#define RENDER_VIDEO_OPENGL_RENDER1_H
...
class OpenGLESRender1 : public VideoRenderInterface, public OpenglesRenderInterface {
...
public:
    ...
    OpenGLESRender1(JNIEnv *env, jobject surface);
    virtual ~OpenGLESRender1();
...
#endif // RENDER_VIDEO_OPENGL_RENDER1_H
