#ifndef OPENGLES_UTILS_NATIVE_IMAGE_H
#define OPENGLES_UTILS_NATIVE_IMAGE_H
...
public:
	...
	static void DumpNativeImage(NativeImage *pSrcImg, const char *pPath, const char *pFileName)
	{
		...
		LOGI("DumpNativeImage fp=%p, file=%s", fp, imgPath);
...
#endif // OPENGLES_UTILS_NATIVE_IMAGE_H
