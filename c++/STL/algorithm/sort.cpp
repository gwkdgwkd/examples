...
// 当操作对象为list或者forward_list序列式容器时，其容器模板类中都提供有sort()排序方法，
...
// 2.如果需要保持排序后各元素的相对位置不发生改变，就只能选择stable_sort()函数，
//   而另外3个排序函数都无法保证这一点；
