...
// 要么都和last迭代器指向相同。
// 需要注意的是，由于equel_range()底层实现采用的是二分查找的方式，
// 因此该函数仅适用于已排好序的序列。
